...
{	
	/// <summary>
	/// Add this class to a character and it'll be able to perform a roll on any platform, even on slopes
	/// Animator parameters : Rolling
	/// </summary>
	...
	{		
		...
		public override string HelpBoxText() { return "This component allows your character to roll on platforms. Here you can define the roll duration, how much force to apply, and the cooldown between the end of a dash and the start of the next one."; }
		...
		// makes character invulnerable to any damage during roll
		public bool Invincibility;

        // 
		public bool CanRoll { get { return (Time.time - _lastRollTimestamp > DashCooldown); }}
        ...
        protected float _lastRollTimestamp = 0f;
		...
		protected virtual IEnumerator Dash()
        {
			...
			while (_timeSinceStart < RollTime && _shouldKeepDashing && _movement.CurrentState == CharacterStates.MovementStates.Dashing)
            {
